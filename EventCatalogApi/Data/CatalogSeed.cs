...
namespace EventCatalogApi.Data
{
    public class CatalogSeed
    {
        ...
        private static IEnumerable<EventDetails> GetDefinedEventDetails()
        {
            ...
            {
                new EventDetails { EventTypeId=1, EventLocationId=2, Description = "AMC Virtual Movie", Name = "Featured Film", Price = 19, Venue="Redmond High School,17272 Northeast 104th Street,Redmond, WA 98052", Occupancy=200, Age="Above 8", Date="May 9, 5PM",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/1" },
                ...
                new EventDetails { EventTypeId=6, EventLocationId=3, Description = "Come celebrate local singer-songwriter, Graham Nash Party!", Name = "Graham Nash Release Party", Price = 20, Age="Above 10", Date="May 9, 7PM", Occupancy=125, Venue="High Dive Renton, Renton, WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/4" },
                new EventDetails { EventTypeId=2, EventLocationId=1, Description = "Giving & Receiving Feedback Skills for Supervisors", Name = "Giving & Receiving Feedback Skills for Supervisors", Price = 80, Age="Above 15", Occupancy=100, Date="May 25, 4PM", Venue="Bellevue College, Bellevue", PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/5" },
                ...
                new EventDetails { EventTypeId=2, EventLocationId=6, Description = "The Business at The Funhouse", Name = "The Business at The Funhouse", Price = 30, Age="Above 21", Occupancy=100, Date="June 3, 7PM", Venue="Funhouse,109 Eastlake Ave E,LynnWood" ,PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/10" },
                ...
                new EventDetails { EventTypeId=5, EventLocationId=8, Description = "Run 2 Be Fit", Name = "Run or Wine 5k", Price = 20, Age="Above 10", Occupancy=200, Date="May 16, 7AM", Venue="Woodinville, WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/13" },
